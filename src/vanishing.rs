...
pub struct ConstructedVar<C: CurveAffine> {
    h_commitments: Vec<AssignedPoint<C>>, // commitment of quotient polynomials
    random_poly_commitment: AssignedPoint<C>,
}
...
impl<C: CurveAffine> PartiallyEvaluatedVar<C> {
    pub fn verify(
        self,
        expressions: impl Iterator<Item = AssignedValue<C>>,
        y: ChallengeY<C>,
        xn: AssignedValue<C>,
